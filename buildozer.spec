...
requirements = python3,kivy,gspread,google-auth,google-auth-httplib2,google-auth-oauthlib,google-api-python-client,oauth2client,httplib2,rsa,cachetools,requests,requests-oauthlib,oauthlib,charset_normalizer,cryptography,pyasn1,pyasn1_modules,urllib3,certifi,idna,pyparsing,six
