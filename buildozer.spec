...
requirements = python3,kivy,gspread,google-auth,google-auth-httplib2,google-auth-oauthlib,requests,requests-oauthlib,cryptography,pyasn1,urllib3,certifi,idna,pyparsing,six
